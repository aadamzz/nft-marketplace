...
import { NFTCard, Loader, Banner, SearchBar } from '../components/index';
  ...
  return (
    <div className="w-full flex justify-start items-center flex-col min-h-screen">
      <div className="w-full flexCenter flex-col ">
        <Banner text="Your Nifty NFTs" childStyles="text-center md-4" parentStyles="h-80 justify-center" />
      ...
      {!isLoading && !nfts.length && !nftsCopy.length ? (
        ...
        <div className="sm:px-4 p-12 w-full minmd:w-4/5 flexCenter flex-col">
          ...
          <div className="mt-3 w-full flex flex-wrap">
            {nfts.map((nft, index) => <NFTCard key={index} nft={nft} onProfilePage />)}
          </div>
        </div>
      ) }
